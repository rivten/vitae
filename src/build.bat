...
set CommonCompilerDebugFlags=/MT /Od /Oi /EHa /WX /W4 %UntreatedWarnings% /Z7 /nologo /I %JSMNPath%
set CommonLinkerDebugFlags=/incremental:no /opt:ref /subsystem:console /ignore:4099

pushd ..\build\
cl %CommonCompilerDebugFlags% ..\src\vitae.cpp /link %CommonLinkerDebugFlags%
popd
